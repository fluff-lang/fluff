...
typedef enum TokenCategory {
    ...
    TOKEN_CATEGORY_ELSE, 
    TOKEN_CATEGORY_FOR, 
    TOKEN_CATEGORY_WHILE, 
    TOKEN_CATEGORY_DECL, 
    TOKEN_CATEGORY_FUNC_DECL, 
    TOKEN_CATEGORY_CLASS_DECL, 
    TOKEN_CATEGORY_CONTROL_KEYWORD, 
    TOKEN_CATEGORY_TYPE_KEYWORD, 
    TOKEN_CATEGORY_MODIFIER_KEYWORD, 
    TOKEN_CATEGORY_REQUIRES, 
    TOKEN_CATEGORY_END, 
